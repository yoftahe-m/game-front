                ...
                <VStack space="sm">
                  ...
                  <Input className="h-12 rounded-full">
                    <InputSlot className="pl-3">
                      <Feather name="mail" size={16} color={colorScheme === 'dark' ? 'white' : 'black'} />
                    </InputSlot>
            ...
            render={({ field: { onChange, onBlur, value } }) => (
              <FormControl isInvalid={isInvalid('password')}>
                <VStack space="sm">
                  ...
                  <Input className="h-12 rounded-full">
                    <InputSlot className="pl-3">
                      <Feather name="lock" size={16} color={colorScheme === 'dark' ? 'white' : 'black'} />
                    </InputSlot>
                    ...
                    <InputSlot className="pr-3" onPress={handleTogglePasswordVisibility}>
                      {showPassword ? (
                        ...
                        <Feather name="eye-off" size={16} color={colorScheme === 'dark' ? 'white' : 'black'} />
                      )}
                    </InputSlot>
                  </Input>
                </VStack>
